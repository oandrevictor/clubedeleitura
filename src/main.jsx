...
const THEMES = [
  ...
  { id: "dark-sepia", label: "Sépia escuro", swatch: "#b48a55", description: "papel escuro quente" },
  { id: "dark-linen", label: "Linho escuro", swatch: "#a8a18f", description: "papel escuro neutro" },
  { id: "dark-indigo", label: "Índigo papel", swatch: "#9aa8d1", description: "papel escuro frio" },
